...
[![CI/CD](https://img.shields.io/badge/CI%2FCD-Placeholder-blue)](https://shields.io/)
...
-   **Langage :** Python
-   **Framework :** [FastAPI](https://fastapi.tiangolo.com/) (suggéré) pour des API performantes et la gestion des WebSockets.
...
2.  **Configuration de l'environnement :**
    Créez un fichier `.env` à la racine du projet en vous basant sur le fichier `docker-compose.yml`. Il devrait contenir les variables nécessaires pour la base de données :
    ```env
    POSTGRES_USER=user
